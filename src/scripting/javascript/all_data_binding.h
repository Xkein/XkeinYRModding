...
UsingTDelegate(void(GameplayAbility*));
UsingTDelegate(bool(GameplayAbility*, GameplayAbilityActorInfo, GameplayAbilitySpecHandle, GameplayTagContainer*));
UsingTDelegate(void(GameplayAbility*, const GameplayEventData&));
UsingTDelegate(void(GameplayAbility*, bool));
UsingTDelegate(void(GameplayCueNotify_Actor*, EGameplayCueEvent, const GameplayCueParameters&));
UsingTDelegate(void(GameplayCueNotify_Static*, const GameplayTag&, const GameplayCueParameters&));
UsingTDelegate(void(GameplayCueNotify_BurstLatent*, const GameplayTag&, const GameplayCueParameters&));
UsingTDelegate(void(GameplayCueNotify_Looping*, const GameplayTag&, const GameplayCueParameters&));
UsingTDelegate(bool(AttributeSet*, FGameplayEffectModCallbackData*));
UsingTDelegate(void(AttributeSet*, const FGameplayEffectModCallbackData*));
UsingTDelegate(void(AttributeSet*, const GameplayAttribute&, float&));
UsingTDelegate(void(AttributeSet*, const GameplayAttribute&, float, float));
UsingTDelegate(void(GameplayAbilityTargetActor*, const GameplayAbilityTargetDataHandle&));
UsingTDelegate(void(GameplayEffectExecutionCalculation*, const FGameplayEffectCustomExecutionParameters&, FGameplayEffectCustomExecutionOutput&));
UsingTDelegate(float(GameplayModMagnitudeCalculation*, const GameplayEffectSpec&));
UsingTDelegate(void(AbilityTask_WaitTargetData*, const GameplayAbilityTargetDataHandle&));
UsingTDelegate(void(AbilityTask_WaitTargetData*));
UsingTDelegate(void(AbilityTask_WaitInput*));
UsingTDelegate(void(AbilityTask_WaitDelay*));
UsingTDelegate(void(AbilityTask_Repeat*, int32));
UsingTDelegate(void(AbilityTask_WaitGameplayTagAdded*));
UsingTDelegate(void(AbilityTask_WaitGameplayTagRemoved*));
UsingTDelegate(void(AbilityTask*));
UsingTDelegate(void(AbilityTask_WaitAttributeChange*, float));
UsingTDelegate(void(AbilityTask_WaitGameplayEvent*, const GameplayEventData&));
UsingTDelegate(void(AbilityTask_WaitGameplayEffectRemoved*));
UsingTDelegate(void(AbilityTask_SpawnActor*, entt::entity));
UsingTDelegate(void(AbilityTask_SpawnActor*));
UsingTDelegate(void(AbilityTask_WaitGameplayEffectApplied*, const GameplayEffectSpec&));

UsingTDelegateRegistration(void(GameplayAbilitySpec*));
UsingTDelegateRegistration(void(GameplayAbility*));

UsingTMulticastDelegate(void(AbilitySystemComponent*, const GameplayEffectSpec&, const ActiveGameplayEffect*));
UsingTMulticastDelegate(void(AbilitySystemComponent*, const GameplayEffectSpec&, ActiveGameplayEffectHandle));
UsingTMulticastDelegate(void(AbilitySystemComponent*, const GameplayAbility*, const GameplayTagContainer&));
UsingTMulticastDelegate(void(AbilitySystemComponent*, GameplayAbility*));
UsingTMulticastDelegate(void(AbilitySystemComponent*, const GameplayAbilitySpecHandle, GameplayAbility*));
UsingTMulticastDelegate(void(AbilitySystemComponent*, const GameplayAbilitySpec&));
UsingTMulticastDelegate(void(AbilitySystemComponent*, const GameplayTag&, int32));
UsingTMulticastDelegate(void(AbilitySystemComponent*, const FGameplayEffectRemovalInfo&));
UsingTMulticastDelegate(void(AbilitySystemComponent*, ActiveGameplayEffectHandle, int32, int32));
UsingTMulticastDelegate(void(AbilitySystemComponent*, ActiveGameplayEffectHandle, float, float));
UsingTMulticastDelegate(void(AbilitySystemComponent*, ActiveGameplayEffectHandle, bool));
UsingTMulticastDelegate(void(AbilitySystemComponent*, const GameplayTag&, const GameplayEventData*));
UsingTMulticastDelegate(void(AbilitySystemComponent*, const FOnAttributeChangeData&));
...
UsingTMulticastDelegateRegistration(void(AbilitySystemComponent*, const GameplayAbility*, const GameplayTagContainer&));
...
UsingScriptFunction(bool(GameplayAbility*, GameplayAbilityActorInfo, GameplayAbilitySpecHandle, GameplayTagContainer*));
UsingScriptFunction(void(GameplayAbility*, const GameplayEventData&));
UsingScriptFunction(void(GameplayAbility*, bool));
UsingScriptFunction(void(GameplayCueNotify_Actor*, EGameplayCueEvent, const GameplayCueParameters&));
UsingScriptFunction(void(GameplayCueNotify_Static*, const GameplayTag&, const GameplayCueParameters&));
UsingScriptFunction(void(GameplayCueNotify_BurstLatent*, const GameplayTag&, const GameplayCueParameters&));
UsingScriptFunction(void(GameplayCueNotify_Looping*, const GameplayTag&, const GameplayCueParameters&));
UsingScriptFunction(bool(AttributeSet*, FGameplayEffectModCallbackData*));
UsingScriptFunction(void(AttributeSet*, const FGameplayEffectModCallbackData*));
UsingScriptFunction(void(AttributeSet*, const GameplayAttribute&, float&));
UsingScriptFunction(void(AttributeSet*, const GameplayAttribute&, float, float));
UsingScriptFunction(void(GameplayAbilityTargetActor*, const GameplayAbilityTargetDataHandle&));
UsingScriptFunction(void(GameplayEffectExecutionCalculation*, const FGameplayEffectCustomExecutionParameters&, FGameplayEffectCustomExecutionOutput&));
UsingScriptFunction(float(GameplayModMagnitudeCalculation*, const GameplayEffectSpec&));
UsingScriptFunction(void(AbilityTask_WaitTargetData*, const GameplayAbilityTargetDataHandle&));
UsingScriptFunction(void(AbilityTask_WaitTargetData*));
UsingScriptFunction(void(AbilityTask_WaitInput*));
UsingScriptFunction(void(AbilityTask_WaitDelay*));
UsingScriptFunction(void(AbilityTask_Repeat*, int32));
UsingScriptFunction(void(AbilityTask_WaitGameplayTagAdded*));
UsingScriptFunction(void(AbilityTask_WaitGameplayTagRemoved*));
UsingScriptFunction(void(AbilityTask*));
UsingScriptFunction(void(AbilityTask_WaitAttributeChange*, float));
UsingScriptFunction(void(AbilityTask_WaitGameplayEvent*, const GameplayEventData&));
UsingScriptFunction(void(AbilityTask_WaitGameplayEffectRemoved*));
UsingScriptFunction(void(AbilityTask_SpawnActor*, entt::entity));
UsingScriptFunction(void(AbilityTask_SpawnActor*));
UsingScriptFunction(void(AbilityTask_WaitGameplayEffectApplied*, const GameplayEffectSpec&));
UsingScriptFunction(void(AbilitySystemComponent*, const GameplayEffectSpec&, const ActiveGameplayEffect*));
UsingScriptFunction(void(AbilitySystemComponent*, const GameplayEffectSpec&, ActiveGameplayEffectHandle));
UsingScriptFunction(void(AbilitySystemComponent*, const GameplayAbility*, const GameplayTagContainer&));
UsingScriptFunction(void(AbilitySystemComponent*, GameplayAbility*));
UsingScriptFunction(void(AbilitySystemComponent*, const GameplayAbilitySpecHandle, GameplayAbility*));
UsingScriptFunction(void(AbilitySystemComponent*, const GameplayAbilitySpec&));
UsingScriptFunction(void(AbilitySystemComponent*, const GameplayTag&, int32));
UsingScriptFunction(void(AbilitySystemComponent*, const FGameplayEffectRemovalInfo&));
UsingScriptFunction(void(AbilitySystemComponent*, ActiveGameplayEffectHandle, int32, int32));
UsingScriptFunction(void(AbilitySystemComponent*, ActiveGameplayEffectHandle, float, float));
UsingScriptFunction(void(AbilitySystemComponent*, ActiveGameplayEffectHandle, bool));
UsingScriptFunction(void(AbilitySystemComponent*, const GameplayTag&, const GameplayEventData*));
UsingScriptFunction(void(AbilitySystemComponent*, const FOnAttributeChangeData&));
