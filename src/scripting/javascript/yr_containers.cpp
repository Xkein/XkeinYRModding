...
UsingPointer(SmudgeClass*const*);
...
UsingPointer(SlaveControl*const*);
...
UsingPointer(VoxelAnimClass*const*);
...
void __JsRegister_YrContainers()
{
    ...
    REGISTER_DYNAMIC_VECTOR_CLASS(VoxelAnimClass*);
    ...
    REGISTER_DYNAMIC_VECTOR_CLASS(SmudgeClass*);
    REGISTER_DYNAMIC_VECTOR_CLASS(SmudgeTypeClass*);
    ...
    REGISTER_DYNAMIC_VECTOR_CLASS(SlaveControl*);
    ...
    REGISTER_DYNAMIC_VECTOR_CLASS(Point2D);
