...
UsingYrClass(TEventClass);
UsingYrClass(TActionClass);
...
UsingCppType(SideClass);
UsingCppType(tagRECT);
...
UsingDynamicVectorClass(VoxelAnimClass*);
...
UsingDynamicVectorClass(SmudgeClass*);
...
UsingDynamicVectorClass(TEventClass*);
UsingDynamicVectorClass(TActionClass*);
...
UsingDynamicVectorClass(ULONG);
UsingDynamicVectorClass(SideClass*);
